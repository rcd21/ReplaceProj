namespace S7.Net
{
    internal class PLCAddress
    {
        ...
        {
            Parse(address, out dataType, out dbNumber, out varType, out startByte, out bitNumber, out name);
        }

        public static void Parse(string input, out DataType dataType, out int dbNumber, out VarType varType, out int address, out int bitNumber, out string name)
        {
            bitNumber = -1;
            dbNumber = 0;
            name = input;
