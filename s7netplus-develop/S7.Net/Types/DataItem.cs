...
namespace S7.Net.Types
{
    ...
    public class DataItem
    {
        ...
        public static DataItem FromAddress(string address)
        {
            ...
            PLCAddress.Parse(address, out var dataType, out var dbNumber, out var varType, out var startByte, out var bitNumber, out string name);
